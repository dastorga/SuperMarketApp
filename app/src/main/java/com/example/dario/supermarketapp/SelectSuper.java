...
public class SelectSuper extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.addOnItemTouchListener(new RecyclerView.OnItemTouchListener() {
            ...
            GestureDetector gestureDetector = new GestureDetector(SelectSuper.this, new GestureDetector.SimpleOnGestureListener() {
    ...
    public void JSON_HTTP_CALL(){
        RequestOfJSonArray = new JsonArrayRequest(SUPER_HTTP_JSON_URL,
        ...
        requestQueue = Volley.newRequestQueue(SelectSuper.this);
